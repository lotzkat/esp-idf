...
printf("Klasse = %d | highest class conf = %.2f\n\n", max_class_conf_index, max_class_conf);

const int TP_Class = 4;
float conf_threshold = 0.3;
float class_conf_theshold = 0.3;

// Gesuchte Klasse:| Geradeaus = 0, Kreisverkehr = 1, Links = 2, Rechts = 3, Stop = 4

if (confidence_score >= conf_threshold && max_class_conf >= class_conf_theshold)
{    
...
printf("Geradeaus = %d, Kreisverkehr = %d, Links = %d, Rechts = %d, Stop = %d\n\n", Geradeaus, Kreisverkehr, Links, Rechts, Stop);
